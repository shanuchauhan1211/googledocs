        ...
        <div className="flex flex-col">
          ...
          <div className="flex ">
            <Menubar className="border-none bg-transparent shadow-none h-auto p-0">
              <MenubarMenu>
                <MenubarTrigger className="duration-300 hover:bg-[#c7c7c7]">
                  File
                </MenubarTrigger>
                      ...
                      <MenubarSub>
                        ...
                        <MenubarSubContent>
                          <div className="p-2">
                            ...
                            <Input
                              value={customRowandCol.initial?.rows || ""}
                              onChange={(e) => {
                                setCustomRowandCol({
                                  ...customRowandCol,
                                  initial: {
                            ...
                            <Input
                              value={customRowandCol.initial?.cols || ""}
                              onChange={(e) => {
                                setCustomRowandCol({
                                  ...customRowandCol,
                                  initial: {
                            ...
                            <Button
                              ...
                              disabled={
                                customRowandCol.initial.rows === 0 ||
                                customRowandCol.initial.cols === 0
                              }
                              className="mt-3 mb-1"
                            >
                              Apply
