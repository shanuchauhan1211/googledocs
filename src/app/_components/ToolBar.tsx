...
const FontSizeButton = () => {
  ...
  return (
    <div className="flex items-center gap-x-1">
      <button
        onClick={decrement}
        className="h-7 flex items-center w-7 justify-center shrink-0 rounded-sm hover:bg-neutral-200/80 "
      >
        {" "}
      ...
      {isEditing ? (
        <input
          ...
          className="h-7 text-sm border text-center border-neutral-400 w-10  rounded-sm hover:bg-neutral-200/80"
        />
      ) : (
        <button
          onClick={() => {
          ...
          className="h-7 text-sm border border-neutral-400 w-10  rounded-sm hover:bg-neutral-200/80 "
        >
          {" "}
          {currentFontSize}
        </button>
    ...
    <>
      <DropdownMenu>
        ...
        <DropdownMenuContent className="p-1 z-50 flex flex-col  items-center rounded-sm  gap-3 gap-x-2 bg-white ">
          <DropdownMenuItem
            className="flex  hover:bg-[#cacaca] cursor-pointer p-1 justify-center items-center gap-2 bg-white rounded-sm "
            onClick={onUpload}
          >
      ...
      <Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
        <DialogContent>
          ...
          <DialogFooter>
            <Button onClick={handelSubmitUrl}>Insert</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
    </>
  ...
  return (
    ...
    >
      <DropdownMenuTrigger asChild>
        <div className="relative  flex flex-col items-center">
          <button
            onMouseEnter={() => setTag("Link Tool")}
            onMouseLeave={() => setTag("")}
            className="h-7  shrink-0     rounded-sm hover:bg-neutral-200/80 px-1  overflow-hidden text-sm "
          >
            <Link2Icon />
          </button>
    ...
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="h-7 w-[100px] shrink-0  border border-[#a7a7a7] flex text-center  items-center justify-between rounded-sm hover:bg-neutral-200/80 px-1  overflow-hidden text-sm ">
          <span className="truncate w-[80px]">{getCurrentHeading()}</span>
      ...
      <DropdownMenuContent className="p-1 z-10 flex flex-col w-[180px]  gap-y-1 bg-white ">
        {headings.map(({ label, value, fontSize }) => (
          <button
            ...
            className={cn(
              "flex flex-col items-center gap-x-2  px-3 py-2 rounded-sm  hover:bg-neutral-200",
              value === 0 ||
      ...
      <DropdownMenuContent className="p-1 z-10 flex flex-col  gap-y-1 bg-white ">
        {fonts.map(({ label, value }) => (
          <button
            ...
            className={cn(
              "flex flex-col items-center gap-x-2  px-2  py-1  rounded-sm  hover:bg-neutral-200",
        ...
        <TooltipTrigger asChild>
          <button
            ...
            className={cn(
              ...
              isActive
                ? "bg-neutral-300 text-[#686868] font-semibold"
