...
const Marker = ({
  ...
  return (
    <div
      ...
      style={{ [isLeft ? "left" : "right"]: `${position - 7}px` }}
    ...
    >
      ...
      <div
        className={`absolute  h-[100vh] bg-slate-700/50 w-[1px] left-1/2 top-4  transform -translate-x-1/2 ${isDragging ? `block` : `hidden`}`}
      />
    </div>
  );
};
